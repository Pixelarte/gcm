...
function initServiceWorker() {
    ...
    "serviceWorker" in navigator ? (console.info("Service Worker is supported"), navigator.serviceWorker.register("/sw.min.js").then(a)) : console.warn("Service workers aren't supported in this browser.");
}
