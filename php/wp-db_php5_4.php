...
<p>Esto puede deberse a que los datos de usuario y contraseña de tu <code>wp-config.php</code> son incorrectos o a que no es posible contactar con el servidor de base de datos en <code>%s</code>, lo que podría significar que el servidor de bases de datos de tu host está inactivo o se ha caído.</p>
<ul>
	<li>¿Seguro de que el nombre de usuario y la contraseña son correctos?</li>
	<li>¿Seguro de que el nombre del host es correcto?</li>
	<li>¿Sseguro de que el servidor de bases de datos está activo?</li>
</ul>
...
'/*/WP_I18N_DB_CONN_ERROR*/, $dbhost ), 'db_connect_fail' );
	...
	function set_prefix( $prefix, $set_table_names = true ) {
		...
		if ( preg_match( '|[^a-z0-9_]|i', $prefix ) )
			return new WP_Error('invalid_db_prefix', /*WP_I18N_DB_BAD_PREFIX*/'Prefijo de base de datos inválido'/*/WP_I18N_DB_BAD_PREFIX*/);
...
<p>Si no sabes crear/configurar tu base de datos, deberías ponerte en contacto con el <strong>soporte de tu empresa de hosting</strong>. Si pese a todo no hay resultados, podrías buscar ayuda en los <a href="http://wordpress.org/support/">Foros de Soporte Oficiales de WordPress</a> (en Inglés), en <a href="http://www.buddypress-es.com/foros/">BuddyPress-es.com</a> (español, No-Oficial) o <a href="http://ayudawordpress.com/foro/">AyudaWordpress.com</a> (español, No-Oficial).</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, $this->dbuser ), 'db_select_fail' );
			return;
		}
	}
